...
import game.main.graphics.GameCamera;
...
public class Game implements Runnable {
	...
	private void render(){
		...
		g.drawString("FPS : " + String.valueOf(handler.getGame().fps), 10, 20);
		g.drawString("Width : " + String.valueOf(handler.getGame().getWidth()), 10, 35);
		g.drawString("Height : " + String.valueOf(handler.getGame().getHeight()), 10, 50);
